...
var str = currentURL;
  var res = str.replace("https://kerakurus.blogspot.com/p/download.html?url=", "");
$(".Visit_Link").hide();
function changeLink(){
...
        } else {
            teks_waktu.innerHTML = "<h3 class='text-danger'>
Link will appear in " + waktu.toString() + " Second</h3>
";
